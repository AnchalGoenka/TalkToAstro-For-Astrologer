...
class AskFreeQuesAdapter(val hubQuestionList: ArrayList<hubQuestionList>, val itemclick: (hubQuestionList, Int) -> Unit): RecyclerView.Adapter<AskFreeQuesAdapter.ViewHolder>() {
